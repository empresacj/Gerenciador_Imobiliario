...
uses
  ...
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Movimentacao, cxGraphics,
  ...
  Vcl.ExtCtrls, UPersistentObject, Padrao, Datasnap.DBClient, Data.FMTBcd,
...
uses
  UCidade, UdmComuns, UfrmCadastroCidades;

{$R *.dfm}

procedure TfrmMovimentacaoCidades.cdsMovimentacaoAfterDelete(DataSet: TDataSet);
begin
  inherited;
